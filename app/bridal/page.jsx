...
export const metadata = {
  ...
  keywords: [
    ...
    'SISIRO bridal',
    'luxury bridal beauty Hyderabad',
  ],
  alternates: {
    canonical: 'https://sisiro.co/bridal',
  },
  openGraph: {
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Bridal Makeup by SISIRO — Hyderabad',
      },
    ],
  },
  twitter: {
    ...
    title: 'Bridal Makeup in Hyderabad | SISIRO Makeup Studio',
    description:
      'Book your dream bridal makeup with SISIRO in Hyderabad. HD and airbrush techniques for your perfect day.',
    ...
    itemListElement: [
      {
        ...
        description: 'High-definition bridal makeup for a flawless on-camera finish.',
        priceCurrency: 'INR',
      },
      {
        '@type': 'Offer',
        name: 'Airbrush Bridal Makeup',
        description: 'Lightweight, long-lasting airbrush makeup for the perfect wedding look.',
        priceCurrency: 'INR',
      },
      {
        '@type': 'Offer',
        name: 'Engagement & Reception Makeup',
        description: 'Personalised makeup looks for engagement ceremonies and receptions.',
        priceCurrency: 'INR',
      },
    ],
  },
