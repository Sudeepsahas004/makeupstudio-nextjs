...
export const metadata = {
  ...
  description:
    'Read what brides and students say about SISIRO Makeup Studio in Hyderabad. Real reviews from weddings, special occasions, and our professional makeup academy.',
  keywords: [
    'SISIRO reviews',
    'bridal makeup reviews Hyderabad',
    'makeup studio testimonials',
    'SISIRO client feedback',
    'wedding makeup Hyderabad reviews',
  ],
  alternates: {
    canonical: 'https://sisiro.co/testimonials',
  },
  openGraph: {
    type: 'website',
    url: 'https://sisiro.co/testimonials',
    title: 'Client Reviews & Testimonials | SISIRO Makeup Studio',
    description:
      'Read what brides and students say about SISIRO Makeup Studio in Hyderabad. Real reviews from weddings, special occasions, and our professional makeup academy.',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'SISIRO Makeup Studio Client Testimonials',
      },
    ],
  },
  twitter: {
    ...
    title: 'Client Reviews & Testimonials | SISIRO Makeup Studio',
    description:
      'Read what brides and students say about SISIRO Makeup Studio in Hyderabad.',
...
const testimonialsSchema = {
  ...
  review: [
    ...
    },
    {
      ...
      reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5' },
      reviewBody:
        'Choosing SISIRO was the best decision for my wedding day. My makeup looked flawless from the ceremony until the reception, and I received countless compliments.',
